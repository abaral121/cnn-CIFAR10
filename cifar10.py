...
Original file is located at
    https://colab.research.google.com/drive/1ZuwHIr8ldvaji2Ng7qRDD6dj9P9tcnal
"""
...
class ConvNet(nn.Module):
    def __init__(self):
        ...
        self.conv_layer = nn.Sequential(
            # Conv layer 1
            nn.Conv2d(in_channels=3, out_channels=32, kernel_size=3, padding=1), # 32 > 32
            nn.BatchNorm2d(32),
            nn.ReLU(),
            nn.MaxPool2d(2,2), # 32 > 16

            # Conv layer 2
            nn.Conv2d(in_channels=32, out_channels=64, kernel_size=3, padding=1), # 16 > 16
            nn.BatchNorm2d(64),
            nn.ReLU(),
            nn.MaxPool2d(2,2), # 16 > 8

            # Conv layer 3
            nn.Conv2d(in_channels=64, out_channels=128, kernel_size=3, padding = 1), # 8 > 8
            nn.BatchNorm2d(128),
            nn.ReLU(),
        ...
        self.fc_layer = nn.Sequential(
            nn.Linear(in_features=128*4*4, out_features=600),
...
sched = lr_scheduler.StepLR(optimizer, step_size = 6, gamma = 0.1)
...
# Faster way of building confusion matrix
